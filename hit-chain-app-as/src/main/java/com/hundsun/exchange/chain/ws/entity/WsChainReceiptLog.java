 ...
 */
@TableName("WS_CHAIN_RECEIPT_LOG")
public class WsChainReceiptLog extends Model<WsChainReceiptLog> {
    ...
    public String getParentReceiptId() {
        return parentReceiptId;
    }

    public void setParentReceiptId(String parentReceiptId) {
